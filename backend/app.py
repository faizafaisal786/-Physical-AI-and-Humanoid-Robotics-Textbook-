...
# Create FastAPI app
app = FastAPI(
    title="Products API with Authentication",
    description="Modern API with cursor-based pagination and BetterAuth-style authentication",
    version="2.0.0",
    lifespan=lifespan
)
...
async def root():
    ...
    return {
        "message": "Products API with Authentication",
        "version": "2.0.0",
        "features": ["cursor-based-pagination", "jwt-authentication", "email-password-auth"],
        "authentication": {
